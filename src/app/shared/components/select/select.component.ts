  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((S) => {
      if (
        ...
        const Q = (this.select_2 && S[this.select_2[0]]) || S[this.select_1[0]];
        ...
        const year = years[0] === years[1] ? years[0] : years.join(' - ');
        ...
        this.selected = this.select_1[0] === 'dates' ? year : match['name'];
      }
    });
  }
